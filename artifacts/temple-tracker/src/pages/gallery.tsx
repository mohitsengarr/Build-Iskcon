                            ...
                            {promptEditId === p.id && (
                              <div className="mt-3 p-3 rounded-xl bg-purple-50 border border-purple-200">
                                <div className="flex items-center gap-2 mb-1.5">
                                  ...
                                  <span className="text-[10px] text-purple-500 ml-auto">{promptDraft.length} chars · house style is appended automatically</span>
                                </div>
                                <textarea
                                  value={promptDraft}
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                  ...
                                  <button onClick={() => setPromptEditId(null)} className="px-3 py-1.5 rounded-lg bg-white text-stone-600 text-xs font-semibold border border-stone-200 hover:bg-stone-50">
                                    Cancel
                                  </button>
                                  <a href="/image-playground" className="ml-auto text-[10px] text-purple-600 hover:underline">Tune model &amp; style in Playground →</a>
                                </div>
                              </div>
                            )}
                          </div>
