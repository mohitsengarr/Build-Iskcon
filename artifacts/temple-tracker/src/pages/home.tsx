...
const STRUCTURED_DATA_WEBSITE = {
  ...
  name: "Build Iskcon", description: "Track 44 active ISKCON temple construction projects across 14 countries.",
...
const FAQ_ITEMS = [
  ...
  { q: "How many ISKCON temples are currently under construction?", a: "As of 2026, Build Iskcon tracks 44 active ISKCON temple construction projects across 14 countries, including the flagship Temple of the Vedic Planetarium (TOVP) in Mayapur." },
      ...
      <div className="relative rounded-t-xl overflow-hidden bg-surface-container-low min-h-[420px] sm:min-h-[460px] flex items-center py-10 sm:py-0">
        ...
        <motion.div className="relative z-20 px-6 sm:px-12 max-w-xl" variants={staggerContainer} initial="hidden" animate="visible">
          ...
          <motion.p variants={fadeInUp} className="text-on-surface-variant font-sans text-[15px] mb-5 leading-relaxed">
            44 ISKCON temples are under construction in 14 countries right now. From the Temple of the Vedic Planetarium in Mayapur to new centres in Nairobi and Budapest — every donation brings Srila Prabhupada's vision closer to reality.
          </motion.p>
    ...
    <motion.section id="projects" className="space-y-10 scroll-mt-24" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm border-collapse" aria-label="ISKCON Temple Construction Projects">
          <caption className="sr-only">All 44 active ISKCON temple construction projects with status, funding progress, and lead organization</caption>
          <thead>
...
export default function Home() {
  return (
    <Layout>
      <SEOHead
        title="Track 44 Active ISKCON Temple Construction Projects Worldwide"
        description="Help build 44 ISKCON temples across 14 countries. The TOVP in Mayapur opens in 2027. Explore projects, donate directly to official ISKCON pages, and discover Vision 2051."
        canonicalPath="/"
        structuredData={[
