  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Track ISKCON temple construction worldwide — see real-time progress, choose a project, and donate directly. 44 temples rising across 14 countries."
        canonicalPath="/"
        structuredData={[
          {
