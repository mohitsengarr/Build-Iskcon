...
export const CHAPTERS: GitaChapter[] = [
  ...
  },
  {
    ...
    subject: "the chain by which this knowledge came down: Krishna above in soft radiance handing the teaching to Vivasvan the sun-god, brilliant on his solar seat, and below him Manu and the king Iksvaku receiving it in turn",
  ...
  },
  {
    ...
    subject: "a still lotus pond at daybreak, broad lotus leaves beaded with water that will not wet them, and on the bank a serene MALE worker at his daily labour, untouched by what he does",
